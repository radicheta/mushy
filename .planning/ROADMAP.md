...
|-------|----------------|--------|-----------|
| 1. Pi Integration & Environment | 4/5 | In Progress|  |
...
- [ ] 06-02-PLAN.md — Register Pi peer in pfSense, enable elder-plops autoconnect, verify mesh connectivity
- [ ] 06-03-PLAN.md — Install ROS2 + CycloneDDS on elder-plops, deploy unicast XML config, verify E2E topic visibility
