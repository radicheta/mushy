...
- ◆ **v1.4 Vision & Growth Insights** — Phases 21–26 (active 2026-04-19) — CV work + farmer↔robot Signal capture channel (Phase 25 added 2026-04-20) + dual-sensor publishing & offline alarms (Phase 26 added 2026-04-29); demo-able artifacts at every phase
...
<details open>
<summary>◆ v1.4 Vision & Growth Insights (Phases 21-26) — ACTIVE</summary>
...
- [ ] **Phase 24: ML vision events via ComfyUI** — **DEFERRED 2026-05-01** — farmer call: with one fixed FC-1 camera, vision alerts only cover whatever fraction of substrate is in frame; gives a demo, not field utility. Blocked on new backlog item 999.26 (roaming or multi-cam coverage). Will revisit once camera-coverage prerequisite ships. Phase scope (24a/24b) preserved as-is for future promotion.
...
- [x] **Phase 26: Dual sensor publishing + offline alarms (SHT30/SCD41)** — added to v1.4 2026-04-29; closes the 2026-04-11 incident class (40-min unnoticed SHT30 outage) by giving each physical sensor its own slot topic + Signal alerts on ≥5min silence with symmetric recovery. **Shipped 2026-04-29** — UAT-8 PASS; SCD41 RH clips at 100% (don't trust its RH); plan-26-02 missed UI demand chain (process lesson captured in memory).
